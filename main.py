...
def main():
    for speed in [50, 80, 120]:
        ...
        print(f'Sicherheitsabstand bei {speed} km/h auf trockener Straße: {safety_distance_meter(speed)}m oder '
              f'{safety_distance_seconds(speed)}s')
        print(f'Anhaltestrecke bei {speed} km/h auf nasser Straße: {safety_distance_meter(speed, dry_road=False)}'
              f'm oder '
              f'{safety_distance_seconds(speed, dry_road=False)}s')
